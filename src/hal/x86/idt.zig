...
pub fn idtInit() void {
    ...
    io.out(.byte, 0x20, 0x11);
    io.out(.byte, 0xA0, 0x11);

    io.out(.byte, 0x21, 0x20);
    io.out(.byte, 0xA1, 0x28);

    io.out(.byte, 0x21, 0x04);
    io.out(.byte, 0xA1, 0x02);

    io.out(.byte, 0x21, 0x01);
    io.out(.byte, 0xA1, 0x01);

    io.out(.byte, 0x21, 0x00);
    io.out(.byte, 0xA1, 0x00);
...
export fn irqHandler(regs: *IDTRegister) void {
    ...
    if (handler) |i|
        i(regs);
    if (regs.int_nb >= 40)
        io.out(.byte, 0xA0, 0x20);
    io.out(.byte, 0x20, 0x20);
}
